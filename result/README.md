...
Trained 3000-sample FNO exports for the three principal experiments:

| Problem | Model | Experiment |
| --- | --- | --- |
| burgers | FNO | `b3000_mse` |
| reaction_diffusion (accu) | FNO | `rd_accu_b3000_mse` |
| cd_disk | FNO | `cd_b3000_mse` |

Only the principal FNO exports are included to keep the repository compact.
CNO, DeepONet, DeepONet-multi, and POD-DeepONet remain fully specified by the
source code and experiment configurations and can be regenerated by training.

> Note: All included trained FNO exports use seed 42. Each operator folder
...
- Operator exports for other training sizes (b1000, b2000) or non-FNO
  backbones. Train them with the commands in `experiments/README.md`.
