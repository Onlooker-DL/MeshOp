...
%
% The 3-D volume is plotted as two slices: z=0 (x-y boundary face) and
% y=0.5 (x-z interior cut, same view as the FEM plots). For every requested
% test sample, the target and predicted panels are written as separate
% compressed image PDFs plus PNGs, without axes numbers or colorbar:
%   <project>/figures/process/ReactionDiffusion/...
%       reaction_diffusion_<op>_<exp>_test<k>_id<id>_<slice>_target.pdf/.png
%       reaction_diffusion_<op>_<exp>_test<k>_id<id>_<slice>_predicted.pdf/.png
