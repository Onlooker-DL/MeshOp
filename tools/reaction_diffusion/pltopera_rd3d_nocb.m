function pltopera_rd3d_nocb(operatorName, operatorExperiment, testIds)
...
%   reaction_diffusion_<op>_<exp>_test<k>_id<id>_3d_nocb_target.pdf/.png
%   reaction_diffusion_<op>_<exp>_test<k>_id<id>_3d_nocb_predicted.pdf/.png
...
function pltopera_rd3d_one(figDir,problemName,operatorName, ...
    ...
    outPdf = fullfile(figDir,sprintf( ...
        '%s_%s_%s_test%03d_id%d_3d_nocb_%s.pdf', ...
